...
export type Fiche = {
  ...
  apercuBrut: {
    ...
    doubles: string[];
    double: string | null;
    /* Les cadrages TELS QU'EN BASE : indexés par clé de coffre, parce que
       l'admin manipule les clés (il réordonne, il remplace) là où la page
       cliente ne voit que des URL signées. */
