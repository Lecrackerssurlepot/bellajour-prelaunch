...
| T-117 | Des féminins résiduels subsistent dans le visible, contraires à la règle du masculin générique | contenu | confort | avis-requis | nouveau — **inventaire fait le 18/09** : 3 sur les pages (deux « arrêtée » sur /numero, un aria-label), 16 dans l'admin (transitions, brief, carnet, urgence, fiche), 1 dans les mails (M10, template 40, accord requis pour repousser), 0 dans les 36 docx légaux ; 40 templates Brevo lus par l'API |
