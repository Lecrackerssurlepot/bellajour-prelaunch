...
| T-113 | Archiver, récupérer et supprimer définitivement un dossier depuis l'admin | admin | serieux | libre | en cours (14/09 : codé, vérifié, déployé, **migration 20260914 appliquée** ; reste le premier usage réel par Mathias sur un dossier de test) |
