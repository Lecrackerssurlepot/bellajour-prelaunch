...
| T-131 | Les photos sans date calées près de leurs voisines de dépôt, en option | admin | confort | libre | en cours (22/09, branche `feat/sans-date-voisines`) : bouton « Sans date : voisines » hors de l'ordre du dépôt ; chaque sans date emprunte la date de sa voisine de dépôt POUR SE RANGER (enveloppe, la vignette reste sans date), entre dans son séjour en « Par lieu » ; le lot suit (`sansDate: "voisines"`) ; harnais +8 |
