...
| T-119 | La page de suivi du numéro fait fouillis (typos, espacements, boutons, trop d'informations) | numero | serieux | libre | **en cours** — 18/09 : planche validée (axe centré), coquille commune + états maquette (PR #173) et couverture (PR #174) en prod ; restent en route, chez vous, attente |
