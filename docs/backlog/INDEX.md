...
| T-119 | La page de suivi du numéro fait fouillis (typos, espacements, boutons, trop d'informations) | numero | serieux | libre | **en cours** — 18/09 : planche validée (axe centré), coquille commune + état maquette en prod (PR #173) ; restent couverture, en route, chez vous, attente |
