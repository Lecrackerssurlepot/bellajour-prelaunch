...
| T-117 | Des féminins résiduels subsistent dans le visible, contraires à la règle du masculin générique | contenu | confort | avis-requis | en cours (18/09) — inventaire fait : 40 templates Brevo lus par l'API, 0 dans les 36 docx légaux ; **pages et admin corrigés** (23 remplacements, harnais vert) ; **M10 corrigé à la source**, reste la poussée du template 40 par Mathias (`--pousser --seulement M10`) |
